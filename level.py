    ...
    def draw(self, canvas):
        if self.background_img:
            canvas.draw_image(
                self.background_img,
                (
                    self.background_img.get_width() // 2,
                    self.background_img.get_height() // 2,
                ),  # Source center
                (
                    self.background_img.get_width(),
                    self.background_img.get_height(),
                ),  # Source size
                (
